...
class _CreateMeetPageState extends ConsumerState<CreateMeetPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      // 빈 공간 탭 시 키보드가 닫히도록 GestureDetector 사용
      body: GestureDetector(
        behavior: HitTestBehavior.opaque, // 전체 영역 터치 가능하도록 설정
        onTap: () {
          // 빈 공간을 누르면 키보드를 닫음
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                // 만들기 버튼 (하단 고정 또는 가운데 정렬 등 필요에 맞춰 수정 가능)
                Center(
                  child: SizedBox(
                    width: 150,
                    height: 50,
                    child: ElevatedButton(
                      onPressed: () async {
                        ...
                        try {
                          final categoryForServer =
                              categoryMapping[_selectedCategory] ?? 'meet';
