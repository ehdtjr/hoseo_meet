...
Future<void> _firebaseMessagingBackgroundHandler(RemoteMessage message) async {
  ...
  // 여기에 백그라운드 메시지 처리 로직(분석, 로그 등) 추가 가능
  print('[FCM 백그라운드] title: ${message.notification?.title}, body: ${message.notification?.body}');
}
...
void main() async {
  ...
  FirebaseMessaging.onMessage.listen((RemoteMessage message) {
    print('[FCM Foreground] 수신: ${message.notification?.title} / ${message.notification?.body}');
    ...
    if (notification != null && android != null) {
      // Foreground 알림 → flutter_local_notifications 로컬 알림 표시
