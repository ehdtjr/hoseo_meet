...
class S3Manager:
    ...
    def upload_byte_file(self, byte_file: BytesIO, destination_path: str, content_type: str = "application/octet-stream") -> str:
        """
        BytesIO 객체를 S3에 업로드하고 URL을 반환.
        """
        try:
            ...
            raise RuntimeError(f"Failed to upload byte file to S3: {e}")
